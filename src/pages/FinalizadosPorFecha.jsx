    ...
    return (
      <section className="mb-6">
        ...
        <div className="space-y-3">
          <Card className="p-3">
            <Skeleton className="h-5 w-1/3 bg-zinc-200 dark:bg-zinc-700 mb-3" />
            <div className="space-y-2">
              <Skeleton className="h-12 bg-zinc-200 dark:bg-zinc-700" />
              <Skeleton className="h-12 bg-zinc-200 dark:bg-zinc-700" />
            </div>
          </Card>
          <Card className="p-3">
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <header className="bg-background border-b px-4 py-3 flex items-center gap-3 lg:hidden flex-shrink-0">
        ...
        <h1 className="text-base font-semibold tracking-tight truncate">📦 Finalizados por fecha</h1>
      </header>
